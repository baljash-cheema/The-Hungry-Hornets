...
WHERE da1.officer_id or da2.officer_id IN
    (SELECT id
...
/*
CAN WE ASK HOW MANY PAIRS OF OFFICERS SHARE THE SAME ALLEGATION CATEGORIES?
*/
...
DROP TABLE IF EXISTS officers_DAM;
CREATE TEMPORARY TABLE officers_DAM AS (
